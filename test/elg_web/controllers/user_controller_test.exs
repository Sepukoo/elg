defmodule ElgWeb.UserControllerTest do
  use ElgWeb.ConnCase

  alias Elg.Identity

  @create_attrs %{email: "some email", fname: "some fname", lname: "some lname", password: "some password", phone: "some phone", wishlist: %{}}
